...
.text
SPLASH:		reset_frame()
		render_ab(splash, zero, zero, 320, 240, zero, zero, zero)
...
SPLASH_RENDER:	lb s0,SPLASH_SEL
		...
		mul t0,s1,s0
		addi t0,t0,168
		render_ab(splash_selection, s2, t0, 160, 28, zero, zero, zero)
		
		xori s0,s0,1
		mul t0,s1,s0
		addi t0,t0,168
		render_ab(splash, s2, t0, 160, 28, zero, s2, t0)
...
GAME:		background_offset(s0, t0)
		render_ab(backgrounds, zero, zero, 320, 240, zero, zero, s0)
		li t0,1
...
GAME_LOOP:	call RECEIVE_INPUT
		...
		add t4,t1,s2
		render_b(backgrounds, t0, t1, t2, t3, s0, t0, t4)
...
#########################################
STATIC_CHAR:	render_ab(char_torso, s1, s2, 48, 32, s0, zero, s4)
		addi s2,s2,32
...
WALK_CONT:	li t1,48
		...
		render_ab(walking_1, s1, s2, 48, 24, s0, t1, s4)
		li t1,1
...
WALK_IDLE:	render_ab(char_legs_idle, s1, s2, 48, 24, s0, zero, s4)
		addi s2,s2,-32
		update_clear(s1, s2, 48, 56)
		jr s9
...
# We use this because jump has a higher range than beq
...
BSOMERSAULT_0:	render_a(landing, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
BSOMERSAULT_1:	render_a(jump, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
BSOMERSAULT_2:	apply_multiplier(8, t1, s5)
		...
		render_a(jump, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
BSOMERSAULT_3:	render_a(jump, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
BSOMERSAULT_4:	apply_multiplier(8, t1, s5)
		...
		render_a(jump, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
BSOMERSAULT_5:	render_a(landing, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
...
FSOMERSAULT_0:	render_a(landing, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
FSOMERSAULT_1:	render_a(jump, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
FSOMERSAULT_2:	apply_multiplier(8, t1, s5)
		...
		render_a(jump, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
FSOMERSAULT_3:	render_a(jump, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
FSOMERSAULT_4:	apply_multiplier(8, t1, s5)
		...
		render_a(jump, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
FSOMERSAULT_5:	render_a(landing, s1, s2, 48, 56, s0, zero, s4)
		j ATTACK_ANIM_E
